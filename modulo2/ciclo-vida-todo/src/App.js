...
class App extends React.Component {
  ...
  buscarAtividadesDoLocalStorage = () =>{
  ...
  componentDidMount() {
    this.buscarAtividadesDoLocalStorage()
    ...
    return (
      <div className="App">
        ...
        <InputsContainer>
          ...
          <button onClick={this.onClickBotaoSalvarInformacoes}>Salvar</button>
        </InputsContainer>
        <br/>
